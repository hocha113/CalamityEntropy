    ...
    public class TlipocasScythe : ModItem, ICEChargeWeapon, IDevItem
    {
        ...
        private void HandleHoldShift(List<TooltipLine> tooltips) {
            ...
            tooltips.Add(new TooltipLine(Mod, "Ability Desc",
                Get("TSA1") + (flag ? "" : Get("LOCKED") + " " + Get("TSU1"))) { OverrideColor = flag ? Color.Yellow : Color.Gray });

            flag = CECal.DownedSlimeGod;
            tooltips.Add(new TooltipLine(Mod, "Ability Desc", GetGate("TSA1B")) { OverrideColor = flag ? Color.Yellow : Color.Gray });

            flag = AllowThrow();
            tooltips.Add(new TooltipLine(Mod, "Ability Desc",
                Get("TSA2") + (flag ? "" : Get("LOCKED") + " " + Get("TSU2"))) { OverrideColor = (flag ? Color.Yellow : Color.Gray) });

            flag = CECal.DownedBrimstoneElemental;
            tooltips.Add(new TooltipLine(Mod, "Ability Desc", GetGate("TSA2B")) { OverrideColor = (flag ? Color.Yellow : Color.Gray) });

            flag = EDownedBosses.downedProphet;
            tooltips.Add(new TooltipLine(Mod, "Ability Desc",
                Get("TSA3") + (flag ? "" : Get("LOCKED") + " " + Get("TSU3"))) { OverrideColor = (flag ? Color.Yellow : Color.Gray) });

            flag = EDownedBosses.downedNihilityTwin;
            tooltips.Add(new TooltipLine(Mod, "Ability Desc",
                Get("TSA4") + (flag ? "" : Get("LOCKED") + " " + Get("TSU4"))) { OverrideColor = (flag ? Color.Yellow : Color.Gray) });

            flag = CECal.DownedPolterghast;
            tooltips.Add(new TooltipLine(Mod, "Ability Desc",
                Get("TSA5") + (flag ? "" : Get("LOCKED") + " " + GetGate("TSU5"))) { OverrideColor = (flag ? Color.Yellow : Color.Gray) });

            // 灾厄在场读神明吞噬者,缺席回落巡游者
            flag = CECal.DownedDoG(EDownedBosses.downedCruiser);
            tooltips.Add(new TooltipLine(Mod, "Ability Desc",
                Get("TSA6") + (flag ? "" : Get("LOCKED") + " " + GetGate("TSU6"))) { OverrideColor = (flag ? Color.Yellow : Color.Gray) });

            flag = CECal.DownedYharon(EDownedBosses.downedCruiser);
            tooltips.Add(new TooltipLine(Mod, "Ability Desc",
                Get("TSA7") + (flag ? "" : Get("LOCKED") + " " + GetGate("TSU7"))) { OverrideColor = (flag ? Color.Yellow : Color.Gray) });

            flag = EDownedBosses.downedCruiser;
            tooltips.Add(new TooltipLine(Mod, "Ability Desc",
                Get("TSA8") + (flag ? "" : Get("LOCKED") + " " + Get("TSU8"))) { OverrideColor = (flag ? Color.Yellow : Color.Gray) });

            flag = CECal.DownedCalamitas(EDownedBosses.downedCruiser);
            tooltips.Add(new TooltipLine(Mod, "Ability Desc",
                Get("TSA9") + (flag ? "" : Get("LOCKED") + " " + GetGate("TSU9"))) { OverrideColor = (flag ? Color.Yellow : Color.Gray) });
        }
        #region Lore，与等级
