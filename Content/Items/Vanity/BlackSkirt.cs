...
{
    public class BlackSkirt : ModItem, IVanitySkin
    {
        ...
        public override void SetDefaults() {
            ...
            Item.Entropy().strokeColor = new Color(255, 198, 205);
            Item.Entropy().NameColor = new Color(130, 110, 120);
            Item.Entropy().NameLightColor = Color.Pink * 0.4f;
        }
