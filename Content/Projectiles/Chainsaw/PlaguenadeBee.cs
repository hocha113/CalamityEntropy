...
{
    //脱离灾厄:灾厄PlaguenadeBee同短名移植(瘟疫蜂,EnslavedStar命中衍生),追踪/反弹/减益逐式对齐,贴图用原版蜜蜂
    public class PlaguenadeBee : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            Main.spriteBatch.Draw(texture, Projectile.Center - Main.screenPosition + new Vector2(0f, Projectile.gfxOffY), new Rectangle(0, drawStart, texture.Width, frameHeight), Projectile.GetAlpha(lightColor), Projectile.rotation, new Vector2((float)texture.Width / 2f, (float)frameHeight / 2f), Projectile.scale, spriteEffects, 0);
            return false;
        }
