    ...
    public class RuneBullet : EBookBaseProjectile
    {
        ...
        public void drawT() {
            ...
            if (odp.Count > 1) {
                ...
                CEUtils.DrawGlow(position + Main.screenPosition, Color.Lerp(Color.White, baseColor * 1.1f, (float)(Math.Cos(Main.GlobalTimeWrappedHourly) * 0.5 + 0.5)), Projectile.scale * 0.6f);
